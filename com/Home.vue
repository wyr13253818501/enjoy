...
<div  @scroll="scroll" ref="content" id="scroll">
	<header class="header">
		<div class="commonHeader">
			...
			<div class="header-two">
				<p>ENJOY</p>
				<b @click="cityKind()" class="iconfont">&#xe728;</b>
			</div>
	...
	<div class="hcontent" v-if="si">
		...
		<div class="citycontent">
			<h5>本地服务开通城市</h5>
			<ul class="cityKind">
				<li @click="goHome(104)">上海</li>
				<li @click="goHome(140)">北京</li>
				<li @click="goHome(144)">南京</li>
				<li @click="goHome(185)">天津</li>
				<li @click="goHome(216)">广州</li>
				<li @click="goHome(235)">成都</li>
				<li @click="goHome(260)">杭州</li>
				<li @click="goHome(299)">深圳</li>
				<li @click="goHome(200)">苏州</li>
				<li @click="goHome(362)">西安</li>
				<li @click="goHome(388)">重庆</li>
				<li @click="goHome(401)">长沙</li>
			</ul>
		</div>
	</div>
